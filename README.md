...
`class adapter_tb` объединяет тестовые сценарии и DUT. Взаимодействие между ними осуществяется посредством интерфейсов `valid_ready_intf` и `valid_credit_intf`.
